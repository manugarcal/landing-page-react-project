...
function App() {
  return (
    <>
      ...
      <Jumbotron title="We love Cats" text="A quick and simple service for getting pictures
       of kittens for use as placeholders in your designs or code. Just put your image size
        (width & height) after our URL and you'll get a placeholder." 
        buttonUrl="https://placekitten.com/" buttonLabel="Go to Place Kitten" />
